...
//------------------------ds18b20-----------------------------
static struct ds18b20_platform_data ds18b20 =
{
	.desc = "ds18b20",
	.gpio = SABERSD_GPIO_DS18B20,
};
static struct platform_device tq_ds18b20_device =
{
	.name       = "ds18b20",
	.id     = -1,
	.dev        = {
		.platform_data  = &ds18b20,
	}
};
...
/*
*/
//#ifdef defined(CONFIG_TOUCHSCREEN_GT811)
...
static void __init mx6_sabresd_board_init(void)
{
	...
	*/
	...
	//  platform_device_register(&tq_ds18b20_device);
